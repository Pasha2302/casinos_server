    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='', max_length=15, verbose_name='Password')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('min_value', models.IntegerField(blank=True, null=True)),
                ('selected_source', models.CharField(blank=True, choices=[('undefined', 'Undefined'), ('terms_and_conditions', 'Terms & Conditions'), ('support', 'Support'), ('website', 'Website')], default=None, max_length=20)),
                ...
                ('symbol_classic', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='min_dip_symbol_classic', to='app_casinos.classiccurrency', verbose_name='Classic Symbol')),
                ('symbol_crypto', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='min_dip_symbol_crypto', to='app_casinos.cryptocurrency', verbose_name='Crypto Symbol')),
            ],
        ),
    ]
